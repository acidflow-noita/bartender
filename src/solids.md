...
<h1 id="acidTitle" class="bartender-heading-decrypted">Solid Materials</h1>
...
```js
const materialsLiquids = materials.filter((d) => d.type === "Solid");
```

```js
const materialsTableFull = Inputs.table(materialsLiquids, {
  columns: [
    "name_and_id",
    "parent_material",
    "density",
